...
from app.schemas.swipe_card import SwipeCard, SwipeCardPreference, SwipeCardCreate, SwipeCardUpdate



class CRUDSwipeCard(CRUDBase[SwipeCard,SwipeCardCreate, SwipeCardUpdate]):
    
    def save_preference(self, db: Session, *, obj_in: SwipeCardPreference) -> MR_Liked_Hated_Member:
    ...
    def get_preference_by_member_id_and_room_uuid(self, db: Session, *, member_id: str, room_uuid:str) -> MR_Liked_Hated_Member:
        return db.query(MR_Liked_Hated_Member).filter(MR_Liked_Hated_Member.member_id == member_id, 
                                                      MR_Liked_Hated_Member.room_uuid == room_uuid).all()
    ...
    def get_self_tag_by_member_id_and_room_uuid(self, db: Session, *, member_id: str, room_uuid:str) -> MR_Member_Tag:
        return db.query(MR_Member_Tag).filter(MR_Member_Tag.member_id == member_id, 
                                                      MR_Member_Tag.room_uuid == room_uuid,
                                                      MR_Member_Tag.is_self_tag == True,
                                                      MR_Member_Tag.is_find_tag == False).all()
    def get_find_tag_by_member_id_and_room_uuid(self, db: Session, *, member_id: str, room_uuid:str) -> MR_Member_Tag:
        return db.query(MR_Member_Tag).filter(MR_Member_Tag.member_id == member_id, 
                                                      MR_Member_Tag.room_uuid == room_uuid,
                                                      MR_Member_Tag.is_self_tag == False,
                                                      MR_Member_Tag.is_find_tag == True).all()
